...
let pp_int32 fmt (s : Scint32__ScalarInt32.scalar_i32) =
  Format.fprintf fmt "%ld" s

let pp_float32 fmt (s : Scfloat32__ScalarFloat32.scalar_f32) =
  Format.fprintf fmt "%f" s

let pretty_int32 fmt t = pretty pp_int32 fmt t
let pretty_float32 fmt t = pretty pp_float32 fmt t

let op_add_int32 = Scint32__OpAdd_Int32.Add.tensor_add
let op_add_float32 = Scfloat32__OpAdd_Float32.Add.tensor_add
